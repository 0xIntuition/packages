...
export const schemaOrgSchedule = {
	id: 'schema:Schedule',
	name: 'Schedule',
	label: 'Schedule',
	comment:
...
export const spec = schemaOrgSchedule;
export const Schedule = schemaOrgSchedule;

export default schemaOrgSchedule;
