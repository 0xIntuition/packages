...
export const schemaOrgSizeSpecification = {
	...
	properties: [
		...
		},
		{
			...
			rangeIncludes: ['SizeGroupEnumeration', 'Text'],
		},
		{
			...
			rangeIncludes: ['SizeSystemEnumeration', 'Text'],
		},
		{
...
export const spec = schemaOrgSizeSpecification;
export const SizeSpecification = schemaOrgSizeSpecification;

export default schemaOrgSizeSpecification;
