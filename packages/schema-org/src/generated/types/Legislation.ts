...
export const schemaOrgLegislation = {
...
export const spec = schemaOrgLegislation;
export const Legislation = schemaOrgLegislation;

export default schemaOrgLegislation;
