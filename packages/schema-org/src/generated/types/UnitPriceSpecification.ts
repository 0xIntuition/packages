...
export const schemaOrgUnitPriceSpecification = {
	...
	properties: [
		{
			...
			rangeIncludes: ['Duration', 'Number', 'QuantitativeValue'],
		},
		{
...
export const spec = schemaOrgUnitPriceSpecification;
export const UnitPriceSpecification = schemaOrgUnitPriceSpecification;

export default schemaOrgUnitPriceSpecification;
