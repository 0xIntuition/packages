...
export const schemaOrgReportageNewsArticle = {
...
export const spec = schemaOrgReportageNewsArticle;
export const ReportageNewsArticle = schemaOrgReportageNewsArticle;

export default schemaOrgReportageNewsArticle;
