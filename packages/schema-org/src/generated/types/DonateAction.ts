...
export const schemaOrgDonateAction = {
...
export const spec = schemaOrgDonateAction;
export const DonateAction = schemaOrgDonateAction;

export default schemaOrgDonateAction;
