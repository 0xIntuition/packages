...
export const schemaOrgEngineSpecification = {
...
export const spec = schemaOrgEngineSpecification;
export const EngineSpecification = schemaOrgEngineSpecification;

export default schemaOrgEngineSpecification;
