...
export const schemaOrgCampingPitch = {
...
export const spec = schemaOrgCampingPitch;
export const CampingPitch = schemaOrgCampingPitch;

export default schemaOrgCampingPitch;
