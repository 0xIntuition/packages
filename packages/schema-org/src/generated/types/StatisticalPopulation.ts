...
export const schemaOrgStatisticalPopulation = {
...
export const spec = schemaOrgStatisticalPopulation;
export const StatisticalPopulation = schemaOrgStatisticalPopulation;

export default schemaOrgStatisticalPopulation;
