...
export const schemaOrgHyperTocEntry = {
...
export const spec = schemaOrgHyperTocEntry;
export const HyperTocEntry = schemaOrgHyperTocEntry;

export default schemaOrgHyperTocEntry;
