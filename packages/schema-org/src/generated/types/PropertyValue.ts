...
export const schemaOrgPropertyValue = {
...
export const spec = schemaOrgPropertyValue;
export const PropertyValue = schemaOrgPropertyValue;

export default schemaOrgPropertyValue;
